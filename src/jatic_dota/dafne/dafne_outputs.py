...
from .smooth_l1 import ModulatedEightPointLoss, SmoothL1Loss
from .sort_corners import sort_quadrilateral
...
def is_in_quadrilateral(c0, c1, c2, c3, poly_area, loc):
    ...
    return ~(
        sum_area_to_loc > (poly_area + 1e-3)
    )  # 1e-3 is some epsilon to avoid equality
    ...
    def dafne_losses(self, instances):
        ...
        if pos_inds.numel() > 0:
            ...
            if self.sort_corners:
                instances.corners_reg_pred = sort_quadrilateral(
    ...
    def predict_proposals(
        ...
        for i, per_bundle in enumerate(zip(*bundle.values())):
            ...
            sampled_boxes.append(
                self.forward_for_single_feature_map(l, o, rc, c, image_sizes, t)
            )
